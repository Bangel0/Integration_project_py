# inventario_app.py
# ------------------------------------------------------------
# Gestor de Inventario en una sola hoja con Streamlit + SQLite
# - CRUD Proveedores
# - CRUD Productos (con selección de proveedor por ID)
# - Filtros
# - Análisis: diagrama de torta, barra y línea
# - Apartado de código para consumir API Spring Boot (requests)
# ------------------------------------------------------------
